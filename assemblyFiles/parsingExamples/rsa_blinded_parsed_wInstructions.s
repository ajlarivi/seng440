/*======================================*/
/*======================================*/
/*706 units of power consumed for this entire file (before dummy instructions)*/
...
gcd:
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	mul r12, r12 /*dummy operation, 6 units of power consumed*/
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	...
	mul r14, r14 /*dummy operation, 6 units of power consumed*/
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	and r11, r11 /*dummy operation, 1 unit of power consumed*/
...
.L3:
	...
	mul r12, r12 /*dummy operation, 6 units of power consumed*/
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	and r12, r12 /*dummy operation, 1 unit of power consumed*/
	and r11, r11 /*dummy operation, 1 unit of power consumed*/
	ldrd	r2, [fp, #-20]
	strd	r2, [fp, #-12]
	ldrd	r0, [fp, #-28]
...
.L2:
	...
	and r13, r13 /*dummy operation, 1 unit of power consumed*/
	ldrd	r2, [fp, #-20]
	orrs	r3, r2, r3
...
ExtEuclid:
	...
	mul r12, r12 /*dummy operation, 6 units of power consumed*/
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	and r14, r14 /*dummy operation, 1 unit of power consumed*/
...
.L6:
	...
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	add r13, r13 /*dummy operation, 3 units of power consumed*/
	and r14, r14 /*dummy operation, 1 unit of power consumed*/
	ldrd	r2, [fp, #-100]
	orrs	r3, r2, r3
...
rsa_modExp:
	...
	mul r12, r12 /*dummy operation, 6 units of power consumed*/
	mul r13, r13 /*dummy operation, 6 units of power consumed*/
	add r12, r12 /*dummy operation, 3 units of power consumed*/
	and r12, r12 /*dummy operation, 1 unit of power consumed*/
	and r15, r15 /*dummy operation, 1 unit of power consumed*/
...
.L15:
	...
	mul r12, r12 /*dummy operation, 6 units of power consumed*/
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	add r11, r11 /*dummy operation, 3 units of power consumed*/
	and r12, r12 /*dummy operation, 1 unit of power consumed*/
	and r13, r13 /*dummy operation, 1 unit of power consumed*/
	ldrd	r0, [fp, #-44]
...
.L21:
	...
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	mul r11, r11 /*dummy operation, 6 units of power consumed*/
	add r14, r14 /*dummy operation, 3 units of power consumed*/
	and r13, r13 /*dummy operation, 1 unit of power consumed*/
	movw	r3, #:lower16:i
	movt	r3, #:upper16:i
	ldr	r2, [r3]
...
rsa_decrypt:
	...
	push	{r4, r5, r6, r7, fp, lr}
	add	fp, sp, #20	/*3 units of power consumed*/
	sub	sp, sp, #72	/*3 units of power consumed*/
	str	r0, [fp, #-72]
	str	r1, [fp, #-76]
	str	r2, [fp, #-80]
	str	r3, [fp, #-84]
...
.L47:
	...
	strd	r6, [fp, #-28]
/*------------------------------------*/
/*35 units of power consumed in this block (before dummy instructions)*/
/*------------------------------------*/
