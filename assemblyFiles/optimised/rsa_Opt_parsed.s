/*======================================*/
/*======================================*/
/*1009 units of power consumed for this entire file (before dummy instructions)*/
...
getRandom:
	...
	bl	rand
	subs	r2, r4, r5
	sbc	r3, r6, r7	/*3 units of power consumed*/
	adds	r2, r2, #1
	adc	r3, r3, #0	/*3 units of power consumed*/
	asr	r1, r0, #31	/*2 units of power consumed*/
	bl	__aeabi_ldivmod
	adds	r0, r2, r5
	adc	r1, r3, r7	/*3 units of power consumed*/
...
rsa_decrypt:
	...
	cmpne	r8, #0
	mov	r7, r0
	beq	.L109	/*7 units of power consumed*/
	mov	r2, r6
	mov	r3, #0
	cmp	r6, #0
	strd	r2, [sp, #16]
	beq	.L127	/*7 units of power consumed*/
	ldrd	r2, [r5]
	ldrd	r0, [r9]
	cmp	r2, #1
	strd	r2, [sp, #24]
	...
	bne	.L113	/*7 units of power consumed*/
	orrs	lr, r2, r3
	...
	beq	.L114	/*7 units of power consumed*/
	cmp	r3, #0
	cmpeq	r2, #1
	beq	.L115	/*7 units of power consumed*/
	orrs	ip, r4, r5
	bne	.L116	/*7 units of power consumed*/
	ldrd	r2, [sp, #8]
	orrs	r3, r2, r3
	beq	.L117	/*7 units of power consumed*/
	ldrd	r10, [sp, #16]
	sub	r3, r7, #1	/*3 units of power consumed*/
	b	.L120	/*7 units of power consumed*/
/*------------------------------------*/
...
.L137:
	...
	cmp	r0, #0
	sbcs	r2, r1, #0
	blt	.L113	/*7 units of power consumed*/
/*------------------------------------*/
/*7 units of power consumed in this block (before dummy instructions)*/
/*------------------------------------*/
...
.L114:
	...
	b	.L112	/*7 units of power consumed*/
/*------------------------------------*/
/*10 units of power consumed in this block (before dummy instructions)*/
/*------------------------------------*/
...
.L112:
	...
	cmpeq	r2, r4
	strb	lr, [ip, #1]!
	bne	.L126	/*7 units of power consumed*/
	mov	r2, r6
	mov	r1, r7
	mov	r0, r8
	bl	memcpy
	b	.L127	/*7 units of power consumed*/
/*------------------------------------*/
...
.L109:
	...
	mov	r8, r10
	bl	fwrite
	b	.L106	/*7 units of power consumed*/
/*------------------------------------*/
/*7 units of power consumed in this block (before dummy instructions)*/
/*------------------------------------*/
...
.L116:
	...
	ldrd	r4, [sp, #8]
	orrs	ip, r4, r5
	beq	.L122	/*7 units of power consumed*/
	subs	fp, r2, #1
	sbc	r3, r3, #0	/*3 units of power consumed*/
	strd	r6, [sp, #36]
...
.L123:
	...
	cmpeq	r0, r6
	strb	r2, [r5, #1]!
	bne	.L140	/*7 units of power consumed*/
	ldrd	r6, [sp, #36]
	ldr	r8, [sp, #44]
	b	.L118	/*7 units of power consumed*/
/*------------------------------------*/
...
.L122:
	...
	ldrd	r6, [sp, #24]
	str	r3, [sp, #8]
	b	.L124	/*7 units of power consumed*/
/*------------------------------------*/
/*10 units of power consumed in this block (before dummy instructions)*/
/*------------------------------------*/
...
.L124:
	...
	cmpeq	r0, r4
	str	r3, [sp, #8]
	bne	.L141	/*7 units of power consumed*/
	ldrd	r6, [sp, #32]
	b	.L118	/*7 units of power consumed*/
/*------------------------------------*/
/*32 units of power consumed in this block (before dummy instructions)*/
